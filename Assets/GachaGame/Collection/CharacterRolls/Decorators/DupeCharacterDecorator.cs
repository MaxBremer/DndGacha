...
public class DupeCharacterDecorator : CharacterRollDecorator
{
    private PlayerCollection _playerCollection;

    public DupeCharacterDecorator(ICharacterRoll decoratedRoll, PlayerCollection playerCollection)
        : base(decoratedRoll)
    {
